          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 lg:p-12 shadow-sm flex flex-col justify-between">
            ...
            <div className="mb-8">
              <div className="w-[150px] sm:w-[180px] md:w-[200px] mb-6">
                <img src="/images/bakso_malang.png" alt="Bakso Malang Enggal Logo" className="w-full h-auto" />
              </div>
              ...
              <p className="text-gray-700 text-sm sm:text-base md:text-lg mb-8 md:mb-12">
                Restoran bakso prasmanan pertama di Indonesia.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <a href="#" className="text-gray-800 hover:text-[#C00000] transition-colors">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
        ...
        <div className="mt-16 max-w-6xl container mx-auto px-4 md:px-10">
          ...
          <div className="space-y-6 text-[#1E1E1E] font-jakarta text-base md:text-lg leading-relaxed max-w-6xl">
            <p className="text-justify">
              Restoran bakso prasmanan pertama di Indonesia ini lahir dari ide sederhana: menghadirkan pengalaman makan yang fleksibel dan menyenangkan. Didirikan pertama kali di Palembang tahun 2008 oleh Founder kami, Bapak Andri Anis, Bakso Malang Enggal langsung menarik perhatian dengan konsep "pilih sendiri bakso dan pelengkap sesuai selera dan sesuka hati," sesuatu yang saat itu belum pernah ada di Indonesia.
            </p>

            <p className="text-justify">
              Namun perjalanan Bakso Malang Enggal tidak selalu mulus. Setelah sempat sukses di Palembang, usaha ini harus tutup. Tapi semangat itu tidak padam. Tahun 2022, Bakso Malang Enggal sempat bangkit kembali di Padang, namun hanya bertahan enam bulan. Hingga akhirnya, di Februari 2023, di bawah manajemen Enggal Group Indonesia, Bakso Malang Enggal kembali lahir di Pekanbaru dengan wajah baru: lebih modern, lebih hangat, lebih siap untuk tumbuh. Dalam waktu singkat, Bakso Malang Enggal menjelma menjadi fenomena baru di industri kuliner Indonesia.
            </p>

            <p className="text-justify">
              Dengan desain restoran yang aesthetic dan family-friendly, Bakso Malang Enggal kini memiliki 15 outlet di seluruh Indonesia per Oktober 2025, dan menjadi inspirasi banyak pelaku usaha kuliner. Kini, Bakso Malang Enggal bukan sekadar tempat makan, tapi simbol inovasi kuliner tradisional yang dikemas modern, aesthetic, dan ramah keluarga.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[#303030] text-sm md:text-base">
                    Jl. Gatot Subroto, Lkr. Sel., Kec. Lengkong,<br />
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-start">
                <button className="bg-[#9C0000] hover:bg-[#7A0000] text-white px-6 py-3 rounded-md font-medium transition-colors">
                  Reservasi Disini
                </button>
                <a
                  href="#"
