            ...
            <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-xl">
                ...
                <p className="max-w-sm font-jakarta text-sm text-[#FFC3C3] sm:text-base md:text-lg lg:hidden mt-4">
                  Kami terbuka untuk kerja sama strategis, dari kemitraan bisnis
                  hingga kolaborasi kreatif.
                </p>
                <button className="mt-8 rounded-xl bg-white py-3 px-6 font-jakarta text-sm md:text-base font-medium transition-all hover:bg-opacity-90 lg:mt-10">
                  <a href="https://wa.me/6281313894340">Hubungi Kami</a>
                </button>
              </div>
      ...
      <div className="container mx-auto max-w-6xl px-10">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-6">
          <div className="flex flex-col gap-8 col-start-1 md:col-span-2 justify-between">
            <img
              ...
              className="w-32 md:w-40 md:mb-0 mb-14"
              alt="Enggal Group"
            />
            <div className="md:flex flex-col gap-4 hidden">
              <h1 className="font-jakarta text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-white">
                Lokasi Head Office
              </h1>
              <div className="flex items-start gap-3">
                <a
                  href="https://maps.app.goo.gl/TyYZHSyybnLpMLCt6"
          ...
          <div className="flex justify-between gap-x-4 col-start-1 lg:col-start-4 col-span-3">
            <div className="text-left">
              <h3 className="mb-4 font-jakarta text-base sm:text-lg md:text-xl font-bold text-white">
                Navigasi
              </h3>
              ...
              <div>
                ...
                <ul className="space-y-4 font-jakarta text-sm md:text-base font-light text-[#CECECE] md:space-y-6">
                  <li className="flex items-center gap-4 justify-start">
                    ...
                    >
                      <path
                        d="M18 0H2C0.9 0 0.00999999 0.9 0.00999999 2L0 14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM17.6 4.25L10.53 8.67C10.21 8.87 9.79 8.87 9.47 8.67L2.4 4.25C2.15 4.09 2 3.82 2 3.53C2 2.96 2.61 2.6 3.09 2.87L10 7L16.91 2.87C17.39 2.6 18 2.96 18 3.53C18 3.82 17.85 4.09 17.6 4.25Z"
                        fill="#CECECE"
                      />
                    </svg>
                    <a
                      href="mailto:contact@enggalgroup.id"
                      className="font-jakarta text-sm text-[#CECECE] hover:text-white transition-colors"
                    >
                      contact@enggalgroup.id
                    </a>
                  </li>
                  <li className="flex items-center gap-4 justify-start">
                    <svg
                    ...
                    >
                      <path
                        d="M4.35239 0C4.52703 2.47136e-06 4.69849 0.0467401 4.84898 0.135363C4.99947 0.223986 5.1235 0.351265 5.2082 0.503992L6.40506 2.65991C6.48223 2.79898 6.52434 2.95476 6.52775 3.11377C6.53117 3.27278 6.49577 3.43023 6.42463 3.57248L5.27181 5.8791C5.27181 5.8791 5.60601 7.59708 7.00447 8.99602C8.40341 10.3945 10.1155 10.7233 10.1155 10.7233L12.4217 9.56999C12.564 9.49876 12.7215 9.46332 12.8806 9.46673C13.0397 9.47014 13.1956 9.51231 13.3347 9.58956L15.4975 10.7923C15.6499 10.8771 15.7768 11.0012 15.8651 11.1516C15.9535 11.3019 16.0001 11.4732 16 11.6476V14.1299C16 15.3943 14.8256 16.3073 13.6278 15.9032C11.1675 15.0728 7.34845 13.4923 4.92782 11.0717C2.50768 8.65106 0.926706 4.83246 0.0968311 2.3717C-0.307342 1.17435 0.605717 0 1.8701 0H4.35239Z"
                        fill="#CECECE"
                      />
                    </svg>
                    <a
                      href="https://wa.me/6281313894340"
                      className="font-jakarta text-sm text-[#CECECE] hover:text-white transition-colors"
                    >
                      +62-813-1389-4340 (Partnership)
                    </a>
                  </li>
                  <li className="flex items-center gap-4 justify-start">
                    <svg
                    ...
                    <a
                      href="https://wa.me/6281313894410"
                      className="font-jakarta text-sm text-[#CECECE] hover:text-white transition-colors"
                    >
                      +62-813-1389-4410 (Customer Care)
                    </a>
                  </li>
                </ul>
              </div>
              <div>
                <h3 className="mb-4 font-jakarta text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-white">
                  Ikuti Kami
                </h3>
                <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 justify-start">
                  <a
                    href="https://www.instagram.com/enggalgroup"
                    className="flex h-10 w-10 sm:h-11 sm:w-11 md:h-12 md:w-12 items-center justify-center rounded-full border border-[#4F4F4F]"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/company/enggalgroup"
                    className="flex h-10 w-10 sm:h-11 sm:w-11 md:h-12 md:w-12 items-center justify-center rounded-full border border-[#4F4F4F]"
                  >
                    <svg
                      width="20"
        ...
        <div className="col-span-6 flex flex-col gap-4 md:hidden mt-10 w-full">
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="font-jakarta text-sm sm:text-base md:text-base leading-relaxed text-[#CECECE]">
              Jl. Boulevard Kota Wisata No.26 Blok C1, <br /> Kel. Ciangsana,
              Kec. Gn. Putri, <br /> Kabupaten Bogor, Jawa Barat 16968
            </p>
          </div>
        </div>

        <div className="mt-10 border-t border-[#4F4F4F] pt-8 text-center">
          <p className="font-jakarta text-sm text-[#CECECE]">
            © Copyright 2026 - PT Makanan Siap Makan
          </p>
        </div>
      </div>
    </footer>
