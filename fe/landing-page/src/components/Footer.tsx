      ...
      <div className="container mx-auto max-w-6xl px-6 md:px-10">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-8 md:col-span-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="font-jakarta text-sm leading-relaxed text-[#CECECE] md:text-base">
          ...
          <div className="text-center md:text-left">
            <h3 className="mb-4 font-jakarta text-lg font-bold text-white">Navigation</h3>
          ...
          <div className="flex flex-col justify-between gap-8 text-center md:text-left">
            ...
            <div>
              <h3 className="mb-4 font-jakarta text-lg font-bold text-white">Ikuti Kami</h3>
              <div className="flex flex-wrap items-center justify-center gap-3 md:justify-start">
                <div className="rounded-full border border-[#4F4F4F] p-4">
